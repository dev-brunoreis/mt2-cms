...
use Mt2Cms\Http\Controller\Admin\AdminAccountsController;
use Mt2Cms\Http\Controller\Admin\AdminAdminsController;
use Mt2Cms\Http\Controller\Admin\AdminAuditLogController;
...
use Mt2Cms\Http\Controller\Admin\AdminGuildsController;
use Mt2Cms\Http\Controller\Admin\AdminItemShopCategoriesController;
...
use Mt2Cms\Http\Controller\Admin\AdminRolesController;
use Mt2Cms\Http\Controller\Admin\AdminNewsPostsController;
use Mt2Cms\Http\Controller\Admin\AdminNewsSettingsController;
use Mt2Cms\Http\Controller\Admin\AdminReferralsController;
use Mt2Cms\Http\Controller\Admin\AdminRefineController;
use Mt2Cms\Http\Controller\Admin\AdminUnstuckController;
use Mt2Cms\Http\Controller\Admin\AdminSettingsController;
use Mt2Cms\Http\Controller\Admin\AdminShopsController;
use Mt2Cms\Http\Controller\Admin\AdminStoreHubController;
use Mt2Cms\Http\Controller\Admin\AdminTicketsController;
...
final class AdminRoutes
{
    public static function register(RouteCollector $r): void
    {
        ...
        $r->addRoute('GET', '/admin/settings/community', [AdminCommunityController::class, 'general']);
        $r->addRoute('POST', '/admin/settings/community', [AdminCommunityController::class, 'saveGeneral']);
        $r->addRoute('GET', '/admin/settings/social', [AdminCommunityController::class, 'social']);
        $r->addRoute('POST', '/admin/settings/social', [AdminCommunityController::class, 'saveSocial']);
        $r->addRoute('GET', '/admin/settings/discord', [AdminCommunityController::class, 'discord']);
        $r->addRoute('POST', '/admin/settings/discord', [AdminCommunityController::class, 'saveDiscord']);
        $r->addRoute('GET', '/admin/settings/channels', [AdminCommunityController::class, 'channels']);
        $r->addRoute('POST', '/admin/settings/channels', [AdminCommunityController::class, 'saveChannels']);
        ...
        $r->addRoute('GET', '/admin/store/categories/{id:\d+}/item-search', [AdminItemShopCategoryProductsController::class, 'categoriesItemSearch']);
        $r->addRoute('POST', '/admin/store/categories/{id:\d+}/products', [AdminItemShopCategoryProductsController::class, 'categoriesAddProducts']);
        $r->addRoute('POST', '/admin/store/categories/{id:\d+}/products/{productId:\d+}', [AdminItemShopCategoryProductsController::class, 'categoriesUpdateProduct']);
        $r->addRoute('POST', '/admin/store/categories/{id:\d+}/products/{productId:\d+}/delete', [AdminItemShopCategoryProductsController::class, 'categoriesRemoveProduct']);
