...
final class AdminRoutes
{
    public static function register(RouteCollector $r): void
    {
        ...
        $r->addRoute('GET', '/admin/admins', [AdminAdminsController::class, 'index']);
        $r->addRoute('GET', '/admin/admins/new', [AdminAdminsController::class, 'create']);
        $r->addRoute('POST', '/admin/admins', [AdminAdminsController::class, 'store']);
        $r->addRoute('GET', '/admin/admins/{id:\d+}', [AdminAdminsController::class, 'edit']);
        $r->addRoute('POST', '/admin/admins/{id:\d+}', [AdminAdminsController::class, 'update']);
        $r->addRoute('POST', '/admin/admins/{id:\d+}/delete', [AdminAdminsController::class, 'destroy']);
        $r->addRoute('GET', '/admin/roles', [AdminRolesController::class, 'index']);
        $r->addRoute('POST', '/admin/roles/mass', [AdminRolesController::class, 'mass']);
        $r->addRoute('GET', '/admin/roles/new', [AdminRolesController::class, 'create']);
        $r->addRoute('POST', '/admin/roles', [AdminRolesController::class, 'store']);
        $r->addRoute('GET', '/admin/roles/{slug:[a-z0-9-]+}', [AdminRolesController::class, 'edit']);
        $r->addRoute('POST', '/admin/roles/{slug:[a-z0-9-]+}', [AdminRolesController::class, 'update']);
        $r->addRoute('POST', '/admin/roles/{slug:[a-z0-9-]+}/delete', [AdminRolesController::class, 'destroy']);
        ...
        $r->addRoute('GET', '/admin/audit-log', [AdminAuditLogController::class, 'index']);
