...
final class AdminLegacyRoutes
{
    public static function register(RouteCollector $r): void
    {
        foreach (array_keys(AdminPaths::legacyStaticMap()) as $oldPath) {
            ...
            $r->addRoute('GET', $oldPath, [AdminLegacyRedirectController::class, 'legacyRedirect']);
        }
        ...
        $r->addRoute('GET', '/admin/news/{id:\d+}', [AdminLegacyRedirectController::class, 'legacyRedirect']);
        $r->addRoute('GET', '/admin/item-shop/{id:\d+}', [AdminLegacyRedirectController::class, 'legacyRedirect']);
        $r->addRoute('GET', '/admin/drops/mob/{id:\d+}', [AdminLegacyRedirectController::class, 'redirectDropMob']);
        $r->addRoute('GET', '/admin/shops/{id:\d+}', [AdminLegacyRedirectController::class, 'legacyRedirect']);
        $r->addRoute('GET', '/admin/refine/{id:\d+}', [AdminLegacyRedirectController::class, 'legacyRedirect']);
        $r->addRoute('GET', '/admin/gms/{id:\d+}', [AdminLegacyRedirectController::class, 'legacyRedirect']);
        $r->addRoute('GET', '/admin/admins/{id:\d+}', [AdminLegacyRedirectController::class, 'legacyRedirect']);
        $r->addRoute('GET', '/admin/roles/{slug:[a-z0-9-]+}', [AdminLegacyRedirectController::class, 'legacyRedirect']);
        $r->addRoute('GET', '/admin/{kind:items|mobs}', [AdminLegacyRedirectController::class, 'legacyRedirect']);
        $r->addRoute('GET', '/admin/{kind:items|mobs}/new', [AdminLegacyRedirectController::class, 'legacyRedirect']);
        ...
        foreach ([
            ...
            $r->addRoute('GET', $pattern, [AdminLegacyRedirectController::class, 'legacyRedirect']);
        }
    }
}
